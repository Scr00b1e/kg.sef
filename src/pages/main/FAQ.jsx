...
const FAQ = () => {
    const faqItems = [
        ...
        { question: "Где и когда проходит финал?", answer: "Ярмарка будет провожаться онлайн" },
        { question: "Как выбираются победители?", answer: "Финал по оригинальности, научной  методологии и презентации [дата]" },
